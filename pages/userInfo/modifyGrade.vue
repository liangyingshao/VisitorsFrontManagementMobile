	...
	<view>
		...
		<view class="margin margin-top-xl">
			<view class="input-group">
				<input class="solids margin-lr padding-left-sm" style="border-radius:30px; padding: 35upx;" focus=true :placeholder='preAge'
			...
			<view class="padding flex flex-direction margin-top-lg">
				<button class="cu-btn bg-sys-purple lg" v-on:click="Modifyage">保存</button>
			</view>
		</view>
	</view>
</template>
